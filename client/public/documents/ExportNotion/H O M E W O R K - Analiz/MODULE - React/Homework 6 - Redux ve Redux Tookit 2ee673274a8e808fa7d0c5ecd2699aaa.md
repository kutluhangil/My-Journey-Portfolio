# Homework 6 - Redux ve Redux Tookit

[**React Uygulamasını Redux Toolkit'e Taşıma Rehberi ve Notları**](Homework%206%20-%20Redux%20ve%20Redux%20Tookit/React%20Uygulamas%C4%B1n%C4%B1%20Redux%20Toolkit'e%20Ta%C5%9F%C4%B1ma%20Rehberi%20%202ee673274a8e8075902add1c2645a617.md)

- **`goit-react-hw-06`** adında bir depo oluşturun.
- Ödev tesliminde iki bağlantı sağlayın: biri kaynak dosyalarına, diğeri ise görevin çalışma sayfasına [**Vercel**](https://vercel.com/) üzerinden.
...
Üçüncü modül ödeviniz olan "İletişim Kitabı" uygulamanızın kodunu yeniden düzenleyin. Durum yönetimini [**Redux Toolkit**](https://redux-toolkit.js.org/) kütüphanesi ile yerel React durumunun yerine ekleyin.
...
React bileşenlerini [**React Redux**](https://react-redux.js.org/) kütüphanesinin **`useSelector`** ve **`useDispatch`** kütüphaneleri ile Redux mantığına bağlayın.
...
İletişim dizisini yerel depolamada saklamak için [**Redux Persist**](https://www.npmjs.com/package/redux-persist) kütüphanesini kullanın.
